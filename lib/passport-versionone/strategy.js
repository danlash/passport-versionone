...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://www7.v1host.com/v1production/oauth.v1/auth';
  options.tokenURL = options.tokenURL || 'https://www7.v1host.com/v1production/oauth.v1/token';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.get('<meta url to query for profile info>', accessToken, function (err, body, res) {
