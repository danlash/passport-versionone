...
Strategy.prototype.authenticate = function(req, options, verify) {
  if (options) {
    this.options.instanceURL = options.instanceURL || this.options.instanceURL;
    this.options.clientID = options.clientID || this.options.clientID;
    this.options.clientSecret = options.clientSecret || this.options.clientSecret;
